...
from dexter.data.datastructures.hyperparameters.base import BaseHyperParameters
...
class DenseHyperParams(BaseHyperParameters):
    def __init__(self, query_max_length: int=128,
                 ...
                 show_progress_bar: bool = True,convert_to_numpy: bool = True, batch_size: int = 64,
